...
module.exports = function() {
    ...
    return {
        ...
        getLocalModelFromORM: function(ormModel, baseModel, _with, _fields) {
            ...
            var _defineGetterSetters = function(model, field) {
                Object.defineProperty(model, field, {
                    ...
                    set: function(newV) {
                        ...
                        if (typeof this._watchers[field] !== 'undefined') {
                            newV = this._watchers[field].call(this, field, newV);
                        }
            ...
            Object.defineProperty(model, '$$isNewRecord', {
                value: !(typeof baseModel !== 'undefined'),
                writable: false,
                configurable: false,
                enumerable: true
            });
            ...
            Object.defineProperty(model, '$watch', {
                value: function(field, cbk) {
                    if (field === '*') {
                        this.getFields().forEach(function(f) {
                            model._watchers[f.name] = cbk;
                        });
                    } else {
