 ...
 *                      your user/custom object as the argument, which will be stored in 
 *                      the 'auth' cookie, or either pass false when authentication fails. 
 *                      An optional 2nd argument is an array of fields that will be available 
 *                      in the cookie; otherwise, all POST fields are going to be saved in the 
 *                      'auth' cookie (BEWARE! not to show passwords).
 * 
...
var path = require('path')
        , lib = require('../')
        , config = require(path.resolve(lib.core.paths.src + '/config/main')).main.auth
