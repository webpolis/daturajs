                                ...
                                fs.mkdir(path.resolve(__dirname+'/../../src/controllers/rest'),0755, function(){
                                    fs.mkdir(path.resolve(__dirname+'/../../src/views'),0755,function(){
                                        fs.mkdir(path.resolve(__dirname+'/../../src/views/layouts'),0755,function(){
                                            ...
                                            // copy rest of files
                                            shell.cp('-R',path.resolve(__dirname+'/skeleton/assets/less/*.less'),path.resolve(__dirname+'/../../src/assets/less'));
                                            shell.cp('-R',path.resolve(__dirname+'/skeleton/assets/css/*.css'),path.resolve(__dirname+'/../../public/css'));
                                            shell.cp('-R',path.resolve(__dirname+'/skeleton/assets/js/*.js'),path.resolve(__dirname+'/../../public/js'));
                                            shell.cp('-R',path.resolve(__dirname+'/skeleton/assets/js/angular/*.js'),path.resolve(__dirname+'/../../public/js/angular'));
                                            shell.cp('-R',path.resolve(__dirname+'/skeleton/assets/img/*.*'),path.resolve(__dirname+'/../../public/img'));
                                            shell.cp('-R',path.resolve(__dirname+'/../controllers/baseController.js'),path.resolve(__dirname+'/../../src/controllers'));
                                            shell.cp('-R',path.resolve(__dirname+'/../controllers/rest/baseController.js'),path.resolve(__dirname+'/../../src/controllers/rest'));
                                        });
                                    });
                                });
                            });
