...
module.exports = function(){
    return {
        input : function(model, attr, opts){
            ...
            attr = typeof model === 'string' && (typeof attr === 'undefined' || attr === null)? model.trim() : attr.trim();
            ...
            // AngularJs support
            if(opts.angular){
                $('input').attr('ng-model', model.$$name+'.'+attr);
                delete opts.angular;
            }
        ...
        label : function(model, attr, opts){
            opts = typeof opts !== 'undefined' ? opts : {};
            attr = typeof model === 'string' && (typeof attr === 'undefined' || attr === null)? model.trim() : attr.trim();
        ...
        select : function(model, attr, opts){
            ...
            // AngularJs support
            if(opts.angular){
                $('select').attr('ng-model', model.$$name+'.'+attr);
                delete opts.angular;
            }
