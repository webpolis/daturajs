...
module.exports = function(ormModel){
    ...
    var model =  {
        ...
        $find:function(type, opts, cbk){
            var findAll, cc, findCustom,conds,params,limit,offset,order, _with = null;
            var _this = this;
            ...
            switch(config.adapter){
                case 'sequelize':
                    ...
                    findAll = function(t){
                        ...
                        return _ormModel.findAll(o).success(function(models){
                            var mm = [];
                            models.forEach(function(m){
                                if(typeof m.name === 'undefined')
                                    m.name = _ormModel.name
                    ...
                    findCustom = function(t){
                        return _ormModel[t](o).success(function(v){
                            cbk(v);
                        });
                    }
                    break;
