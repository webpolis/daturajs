...
exports.model = {
	...
	fields : [
		...
		{name : 'invoice_type_name', label : 'invoice_type_name'.humanize(), type : 'string', required : false, max : 100},
		{name : 'invoice_type_code', label : 'invoice_type_code'.humanize(), type : 'string', required : false, max : 50},
	],
