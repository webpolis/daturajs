...
exports.model = {
	...
	fields : [
		...
		{name : 'permission_name', label : 'permission_name'.humanize(), type : 'string', required : false, max : 50},
		{name : 'description', label : 'description'.humanize(), type : 'string', required : false, max : 250},
	],
